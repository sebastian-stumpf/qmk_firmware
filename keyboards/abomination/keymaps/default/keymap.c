...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] =  LAYOUT(
        ...
        A_LT,    S_LT,    D_LT,    F_LT,    DE_G,    KC_MPRV, KC_MNXT,      DE_H,    J_LT,     K_LT,    L_LT,    HASH_LT,
        DE_Y,    DE_X,    DE_C,    DE_V,    DE_B,    TG(NUM), KC_MPLY,      DE_N,    DE_M,     DE_COMM, DE_DOT,  DE_MINS,
    ...
    [NUM] =  LAYOUT(
        ...
        KC_LGUI, KC_LALT,    KC_LCTL,    KC_LSFT,    XXXXXXX, TO(BASE), _______,             DE_4,    DE_5,    DE_6,    DE_PIPE, DE_LABK,
    ...
    [MOUSE] =  LAYOUT(
        ...
        KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, XXXXXXX, _______, _______,      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
