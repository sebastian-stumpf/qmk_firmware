...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [SYM] = LAYOUT_split_3x6_3(
        ...
        _______,        XXXXXXX,      XXXXXXX,      XXXXXXX,      DE_ADIA,      DE_ODIA,     XXXXXXX, KC_LSFT,      KC_LCTL,      KC_LALT,        KC_LGUI,         XXXXXXX,
        XXXXXXX,        XXXXXXX,      XXXXXXX,      XXXXXXX,      DE_GRV,       DE_CIRC,     XXXXXXX, XXXXXXX,      XXXXXXX,      KC_ALGR,        XXXXXXX,         _______,
